...
| [`CHARTER.md`](docs/CHARTER.md) | 보일러플레이트 헌장 — 미션, IN/OUT 범위, 설계 원칙, 확장 포인트, 분기 체크리스트 |
| [`CONTRIBUTING.md`](docs/CONTRIBUTING.md) | 일상 개발 워크플로우, 브랜치/커밋/PR/리뷰/마이그레이션/테스트/FAQ |
| [`SECURITY.md`](docs/SECURITY.md) | 보안 취약점 보고·대응 정책, 빌트인 보안 레이어 정리 |
| [`ROADMAP.md`](docs/ROADMAP.md) | 향후 권장 작업 (Dependabot, e2e, 운영 등) |
